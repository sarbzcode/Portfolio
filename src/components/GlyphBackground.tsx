...
const BACKGROUND_CSS_VAR = '--app-background';
...
const GlyphBackground = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener(BACKGROUND_CHANGE_EVENT, handleBackgroundChange as EventListener);
  ...
  return (
    <canvas
      ...
      style={{
        ...
        filter: 'blur(5px)',
        opacity: 0.6,
        backgroundColor: 'var(--app-background, #050608)',
      }}
    />
  );
};
